...
<!-- v-for -->
  ...
  main
    ...
    style="padding: 10px 0; margin: 0 auto; width: 90%;")
      ...
      q-carousel(class="bg-grey-1 rounded-borders"
      style="height: 100%;"
      ...
      @mouseleave="autoplay = true" )
        ...
        q-carousel-slide(:name="1" class="column no-wrap")
          div(class="row fit justify-start items-center q-gutter-xs q-col-gutter no-wrap")
            ...
            v-for="firstDataItem in firstDataList"
            style="max-width: 300px;  height: 400px; margin: 10px;" )
              q-img(:src="firstDataItem.imgurl" style="height: 170px;")
              q-card-section
                  div(class="row no-wrap items-center")
                  div(class="col text-h6 ellipsis") {{ firstDataItem.name }}
                  q-card-section(class="q-pt-none")
                  div(class="text-caption") {{ firstDataItem.address }}
              q-card-section(class="q-pt-none")
                div(class="text-caption text-grey") {{ firstDataItem.comments }}
                div(class="text-subtitle2 text-red") {{ firstDataItem.price }} 원~
