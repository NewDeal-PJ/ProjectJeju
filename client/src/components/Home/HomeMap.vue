...
div(class="q-pa-md" style="max-width: 90%; overflow:hidden; margin: 0 auto; text-align: center;")
  q-btn-dropdown(split push no-caps @click="displayHotel(category, filter, locationFilterHotel)" style="margin-top: 10px;margin-left: 0.8rem; margin-right: 0.9rem; width: 19rem; height: 3rem; position: relative; z-index: 10; border: 3px solid #f04040; color: #f04040; background-color: #fafafa;")
    template(v-slot:label)
      div(class="row items-center no-wrap")
        q-icon(left name="img:https://jejuprojectimage.s3.ap-northeast-2.amazonaws.com/hotel.svg")
        div(class="text-center" style="font-size: 1.3rem;") 숙소
  ...
  q-btn-dropdown(split push no-caps @click="displayStore(locationFilterStore)" style="margin-top: 10px;margin-left: 0.8rem; margin-right: 0.9rem; width: 19rem; height: 3rem; position: relative; z-index: 10; border: 3px solid #ffc107; color: #ffc107; background-color: #fafafa;")
    template(v-slot:label)
      div(class="row items-center no-wrap")
        q-icon(left name="img:https://jejuprojectimage.s3.ap-northeast-2.amazonaws.com/store.svg")
        div(class="text-center"  style="font-size: 1.3rem;") 맛집
    div(class="q-gutter-sm" style="margin-right: 0.75rem;")
  ...
  q-btn-dropdown(split push no-caps @click="displayCharger(locationFilterCharger)" style="margin-top: 10px;margin-left: 0.8rem; margin-right: 0.9rem; width: 19rem; height: 3rem; position: relative; z-index: 10; border: 3px solid #03a9f4; color: #03a9f4; background-color: #fafafa;")
    template(v-slot:label)
      div(class="row items-center no-wrap")
        q-icon(left name="img:https://jejuprojectimage.s3.ap-northeast-2.amazonaws.com/chargerloc.svg")
        div(class="text-center"  style="font-size: 1.3rem;") 전기차 충전소
    div(class="q-gutter-sm" style="margin-right: 0.75rem;")
  ...
  q-btn-dropdown(split push no-caps @click="displayCharger(locationFilterCharger)" style="margin-top: 10px;margin-left: 0.8rem; margin-right: 0.9rem; width: 19.5rem; height: 3rem; position: relative; z-index: 10; border: 3px solid #ff9800; color: #ff9800; background-color: #fafafa;")
    template(v-slot:label)
      div(class="row items-center no-wrap")
