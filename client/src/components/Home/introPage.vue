<template>
  ...
  <div class="q-pa-md" style="padding: 0; overflow: hidden;">
    <q-carousel arrows animated v-model="slide" infinite
      transition-prev="slide-right" transition-next="slide-left" @mouseenter="autoplay = false"
      @mouseleave="autoplay = true" style="height: 100%; width: 100%; position: fixed;">
      ...
      <q-carousel-slide name="second"
        ...
        <div class="absolute-bottom "
        style="text-align: center; padding: 40vh 0px; color: white; font-family: 'Nanum Gothic Coding', monospace;">
          <div style="font-family: 'Black Han Sans', sans-serif; font-size: 40px; ">J-TRACK을 이용하는 TIP 1 </div>
          <div style="font-size: 25px;">“나만의 경로 만들기” 버튼을 통해 원하는 목적지에 깃발을 꽂아주세요!<br/>반경 2km 내의 숙박과 맛집 정보를 알려드립니다.</div>
      ...
      <q-carousel-slide name="third"
        ...
        <div class="absolute-bottom "
        style="text-align: center; padding: 40vh 0px; color: white; font-family: 'Nanum Gothic Coding', monospace;">
          <div style="font-family: 'Black Han Sans', sans-serif; font-size: 40px; ">J-TRACK을 이용하는 TIP 2</div>
          <div style="font-size: 25px;">지도에서 원하시는 숙소, 맛집을 선택하여 사람들이 남긴 리뷰를 확인하세요!<br/>키워드로 만들어진 워드클라우드도 볼 수 있습니다.  </div>
        </div>
      </q-carousel-slide>

      <template v-slot:control>
        <q-carousel-control position="bottom" :offset="[16, 8]" class="text-white text-center rounded-borders"
