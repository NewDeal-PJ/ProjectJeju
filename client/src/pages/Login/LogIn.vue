      ...
      <div>
        ...
        <div class="LoginIdBox">
          <div
            ...
            style="width: 24rem; max-width: 100%; margin: 0 auto;"
          >
            <q-input
              outlined
        ...
        <div class="LoginButton">
          <q-btn
            @click="submit()"
            style="color: white; background-color: #F79a38; width: 24rem; max-width: 100%; margin: 0 auto; display: block; padding: 10px; margin-top: 10px;"
          >
        ...
        <hr
          class="two"
          style="width: 500px; max-width: 100%; color:gray; border: thin solid;"
        />
      </div>
      <LoginApi></LoginApi>
    </div>
